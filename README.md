...
The **worked solutions** include complete code and explanations. From Lecture 3 onward, the **concept notes** offer expandable explanations and the **Java examples** provide downloadable solution files, sample inputs, and expected outputs. Lecture 2’s code and definitions are included in its slides and demo handout.
