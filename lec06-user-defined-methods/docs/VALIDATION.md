...
- Instructor pass: three small results, explicit code/slide mapping, predictions and recovery notes; approximately 30 minutes.
- Independent-study pass: complete code and output, visible concept definitions, worked traces, hidden self-check answers, and explicit deferred scope.

Source extraction, page renders, screenshots, test harnesses, and print QA output are local working evidence, not publisher material for distribution. The licensed PDF remains ignored by Git.
