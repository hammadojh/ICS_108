# ICS 108 Lecture 8 — Object references and wrappers

About 35 minutes, with three extensions of the campus wallet from Lecture 7.

- [Student problems](student-problems.md): brief, solution-free prompts and expected output.
...
|---|---|---|
| 1 | Start wallets in two ways | 3–6 |
| 2 | Transfer through an alias | 7–10 |
| 3 | Add an optional Integer reward | 11–15 |

Start with the student problem before opening the instructor solution. All HTML works offline. The supplied zyBooks PDF stays private; access it through authorized course channels.
